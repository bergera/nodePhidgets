...
PhidgetTemperature.prototype.setTemperatureChangeTrigger = function(index, value) {

}

PhidgetTemperature.prototype.setThermocoupleType = function(index, value) {
...
PhidgetTemperature.prototype._parsePhidgetSpecificData = function (data) {
  ...
  if (data.keyword === 'AmbientTemperature') {
     ...
     * @param {PhidgetTemperature} emitter The actual PhidgetTemperature object that emitted the
     * event.
